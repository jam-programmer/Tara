namespace Application.Common
{
    public record DefaultData
    {
        ...
        public const string TemporaryTokenCacheKry = "JanSnakTemporaryToken";
        public const string TemporaryAuthenticateTokenCacheKry = "JanSnakTemporaryAuthenticateToken";


        public const string OnlinePurchaseUserName = "tara_ipg";
        public const string OnlinePurchasePassword = "tara_ipg@123_$";
    }
}
